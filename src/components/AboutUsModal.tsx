          ...
          <div className="p-6 space-y-6 overflow-y-auto h-[calc(80vh-80px)] no-scrollbar pb-12">
            <div className="bg-white p-6 rounded-[24px] border border-gray-100 shadow-sm text-center">
               ...
               <p className="text-xs font-medium text-gray-500 leading-relaxed">
                 Founded on June 25, 2026, EARNOVA is a premier digital task ecosystem providing sustainable income opportunities through micro-work and fintech innovative solutions.
               </p>
            </div>
